...
class Block:
    ...
    def toJSON(self):
        ...
        #json.dumps : dic을 str형태로 바꿈
        #ex) (labmda x,y : x+y)(10,20) -> 30
        ...
        if None != re.search('/block/*', self.path):
            if None != re.search('/block/getBlockData', self.path):
               ...
               # 블록 요청 from에 음수값, 0값 예외 처리
                ...
                # queryString = ['http://localhost:8666/block/getBlockData?from=1', 'end=10']
                ...
                try:
                    ...
                    if block == None:
                        ...
                        if startPoint <= 0:
                            print("You cannot output negative numbers. It starts at 0.")
                            # 음수는 출력할 수 없습니다. 0부터 시작합니다.
                            data.append("You cannot output negative numbers. It starts at 0.")
                            startPoint = 0
                        ...
                        if len(block) < endPoint:
                            print("IndexError : Set endPoint to the number of blocks.")
                            # endPoint를 block의 갯수로 설정합니다.
                            data.append("IndexError : Set endPoint to the number of blocks.")
                            endPoint = len(block)
